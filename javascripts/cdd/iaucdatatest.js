...
<button id="signout-button" onclick="handleSignOutClick()" class="print-button" style="width:80px" >Sign out</button>
    ...
    `;		
		...
		quicksettings.innerHTML =	`<span id="qsmessage" class="bluetext">You need to select either <span class="orangetext">INPUT JDB</span> or <span class="greentext">INPUT GSS</span></span>
...
<td style="text-align:center; padding:1px; font-size:medium; color:white;"></td>

</tr><tr>
<td>
<label class="optionslabel orangetext"><input class="SendDataToDB" class="mycheckbox" type="checkbox">Input JDB</label>
</td>
<td>
<label class="optionslabel"><input id="popversion2" class="mycheckbox" type="checkbox">Popup v2</label>
</td>
</tr>

<tr>
<td>
<label class="optionslabel greentext"><input class="SendDataToGSS" class="mycheckbox" type="checkbox">Input GSS</label>
</td>
<td>
<label class="optionslabel"><input id="autocheck" class="mycheckbox" type="checkbox">Auto Sayuri</label>
</td>
</tr>
	...
	setTimeout(function () {
		...
		for (var i = 0; i < rdb.length; i++) {
			...
			if (cph != null) {
				if (cph.length > 0) {
					rdb[i].value = cph;
					rdb[i].parentElement.style["background-color"] = "pink";					
